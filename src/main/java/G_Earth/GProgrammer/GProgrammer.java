...
public class GProgrammer extends ExtensionForm {
	...
	public void handleImport(ActionEvent e) {
		...
		switch (text) {
			case "setTimeout":
				urlToImport = "https://gist.githubusercontent.com/salomvary/5a295d32e0868ffde42a/raw/ea33f4daad419f419188b1c7f89d76bf8e385b4d/settimeout-nashorn.js";
				break;
			case "Promise":
		...
		if (currentCode.contains(textToInsert)) return;
	...
	public void handleSnippet(ActionEvent e) {
		...
		String currentCode = codeText.getText();
		if (currentCode.contains(snippetToImport)) return;
