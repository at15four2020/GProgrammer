...
print(" - intercept(TOCLIENT, headerIdOrName, handler)")
print(" - interceptToClient(headerIdOrName, handler)")
print("   --> Start intercepting packets from server with the headerId")
print(" - intercept(TOSERVER, headerIdOrName, handler)")
print(" - interceptToServer(headerIdOrName, handler)")
print("   --> Start intercepting packets from client with the headerId\n")

print(" - send(TOSERVER, packet)")
print(" - sendToServer(packet)")
print("   --> Send the packet to the server")
print(" - send(TOCLIENT, packet)")
